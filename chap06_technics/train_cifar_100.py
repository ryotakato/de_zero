...
from dataset.cifar_100 import load_cifar_100
...
(x_train, t_train), (x_test, t_test) = load_cifar_100(normalize=True, one_hot_label=True)
...
networks = {
            "chap06+AdaGrad+weight init he+batchnorm+hidden100,100,50:": {"network":MultiLayerNetExtend(input_size=3072, hidden_size_list=[100,100,50], output_size=100, weight_init_std="sigmoid", use_dropout=False, use_batchnorm=True), "optimizer": AdaGrad()},
            }
