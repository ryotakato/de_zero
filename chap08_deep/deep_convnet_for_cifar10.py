...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(3, 32, 32),
                 ...
                 hidden_size=1024, output_size=10):

        # init weights
        pre_node_nums = np.array([1*3*3, 64*3*3, 64*3*3, 128*3*3, 128*3*3, 256*3*3, 256*4*4, hidden_size])
        weight_init_scales = np.sqrt(2.0 / pre_node_nums) # recommend value when we use Relu
        ...
        self.params['W7'] = weight_init_scales[6] * np.random.randn(256*4*4, hidden_size)
